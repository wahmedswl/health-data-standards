    ...
    module Cat1
      ...
      class FamilyHistoryImporter < CDA::SectionImporter
        ...
        def initialize(entry_finder = CDA::EntryFinder.new("//cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.22.4.46']"))
          ...
          @age_xpath= "./cda:entryRelationship/cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.22.4.31']/cda:value"
          @cause_of_death_xpath = "./cda:entryRelationship/cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.22.4.47']"
          @subject_xpath = "../../cda:subject/cda:relatedSubject"
          ...
          if subject
            ...
            if code_element
              parent_entry.subject = {"code" => code_element["code"], 
                                      "code_system" => HealthDataStandards::Util::CodeSystemHelper.code_system_for(code_element["codeSystem"])}

            end
            extract_gender(parent_entry, subject)
            extract_birth_time(parent_entry,subject)
          end
        end
        ...
        def extract_age(parent_entry, element)
          ...
          if age
            parent_entry.age = {"value" => age["value"], "unit" => age["unit"]}
          end
        end
