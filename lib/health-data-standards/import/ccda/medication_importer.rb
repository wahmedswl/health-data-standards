  ...
  module Import
    module CCDA
      ...
      class MedicationImporter < CDA::MedicationImporter
        ...
        def initialize
          super(CDA::EntryFinder.new("//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.22.2.1' or cda:templateId/@root='2.16.840.1.113883.10.20.22.2.1.1' or cda:templateId/@root='2.16.840.1.113883.10.20.22.2.38' or cda:templateId/@root='2.16.840.1.113883.3.88.11.32.8' or cda:templateId/@root='2.16.840.1.113883.3.88.11.83.8']/cda:entry/cda:substanceAdministration"))
